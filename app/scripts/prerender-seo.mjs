...
function routeImagePreload(page) {
  ...
  if (page.path === "/") {
    ...
    return [
      ...
      `<link rel="preload" href="/assets/manhattan-900.webp" imagesrcset="/assets/manhattan-480.webp 480w, /assets/manhattan-640.webp 640w, /assets/manhattan-900.webp 900w" imagesizes="(min-width: 64rem) 640px, 100vw" as="image" type="image/webp" fetchpriority="high">`,
    ].join("\n");
  }
...
function snapshot(page) {
  ...
  const inlineStyles = `
    ...
    .lf-seo .lf-seo__home-backdrop img { display: block; width: 100%; height: 100%; object-fit: cover; object-position: 50% 35%; opacity: 1; filter: blur(1px); transform: scale(1.02); }
    .lf-seo .lf-seo__home-backdrop::after { position: absolute; inset: 0; content: ""; background: linear-gradient(90deg, rgb(5 5 7 / 84%) 0%, rgb(5 5 7 / 58%) 38%, rgb(5 5 7 / 12%) 70%, rgb(5 5 7 / 4%) 100%), linear-gradient(180deg, rgb(5 5 7 / 40%) 0%, rgb(5 5 7 / 0%) 28%, rgb(5 5 7 / 30%) 62%, rgb(5 5 7 / 100%) 100%); }
  ...
  const homeBody = `
    <section class="lf-seo__home-hero" aria-label="Little Fight NYC" data-lf-owner-intro="true">
      <div class="lf-seo__home-backdrop" aria-hidden="true"><img src="/assets/manhattan-900.webp" srcset="/assets/manhattan-480.webp 480w, /assets/manhattan-640.webp 640w, /assets/manhattan-900.webp 900w" sizes="(min-width: 64rem) 640px, 100vw" width="900" height="514" alt="" fetchpriority="high" decoding="async"></div>
