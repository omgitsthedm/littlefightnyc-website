...
const cards = [
  {
    ...
    title: "We handle the tech. You run the shop.",
  ...
  },
  {
    ...
    category: "WHAT WE DO",
    title: "Websites, fixes, and software you own.",
    note: "Pick the one that sounds like your day. The first look is free.",
  ...
  },
  {
    file: "og-about.jpg",
    category: "ABOUT",
    title: "One studio for all of it.",
    note: "The website, the fixes, and the software you own. Since 2021.",
