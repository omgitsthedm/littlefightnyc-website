...
if (answerRoutes.length !== 32) {
  fail(`answer route coverage: expected 32 routes, found ${answerRoutes.length}`);
}
...
console.log(
  "Visual-proof coverage audit passed: 32 answers, 37 journal insights, 72 noindex service-area routes, revenue paths, owner calculators, motion limits, citations, and protected boundaries.",
);
