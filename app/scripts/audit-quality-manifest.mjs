...
const qualityCharter = path.resolve(repoRoot, "..", "..", "..", "agency-ops", "quality", "QUALITY-CHARTER.md");
if (!(await exists(qualityCharter))) {
  const message =
    "central Quality Charter is unavailable at agency-ops/quality/QUALITY-CHARTER.md; debt record QSP-001 remains open";
