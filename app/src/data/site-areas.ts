...
const AREA_OWNER_CONTEXT: Record<string, AreaOwnerContext> = {
  ...
  chelsea: {
    ...
    intro: "You get a calmer public front door: quick questions get an answer now, and serious appointment or project inquiries get a fuller conversation. Deciding which is which is the work.",
  ...
  midtown: {
    ...
    intro: "You get a first screen that answers the practical question before the customer scrolls. In Midtown nobody excavates a buried answer with a tiny phone shovel; they leave.",
  ...
  "upper-west-side": {
    ...
    intro: "You get one public page that welcomes both regulars and newcomers, so a first-time customer never has to work for an answer a regular already knows.",
  ...
  "west-village": {
    ...
    intro: "You keep the character and lose the mystery: reservations, requests, and the phone number are easy to find. A little charm is lovely; a hidden phone number is just cardio.",
  ...
  williamsburg: {
    ...
    intro: "You get to move fast without asking every customer to decode the latest post: the changing piece stays flexible, the basic path stays steady.",
  ...
  bushwick: {
    ...
    intro: "You keep social, and the post, the profile, and the website start pointing to the same current truth — hours, contact, and the next step.",
  ...
  "park-slope": {
    ...
    intro: "You get less phone tag: the planning information a first-time customer needs sits where they can actually use it, before they commit time.",
  ...
  dumbo: {
    ...
    intro: "You get proof that leads somewhere: a new contact sees the work and knows what to do next. Strong work with no handoff is a dead-end portfolio.",
  ...
  astoria: {
    ...
    intro: "You keep the familiar way you serve people, and the public facts get easier for a new customer to understand on a first phone visit.",
  ...
  "long-island-city": {
    ...
    intro: "You get the address, access, pickup, or appointment handoff made clear before the customer starts a trip — one less small headache for everyone.",
  ...
  "greenwich-village": {
    ...
    intro: "You keep the business spontaneous and the public facts steady: the plan may change, but the place a customer checks does not.",
  ...
  "financial-district": {
    ...
    intro: "You get a public page that does the simple job first — service, location, next step — because a Financial District customer decides in a short window.",
  ...
  "the-bronx": {
    ...
    intro: "You get the basics — service, phone, price context, next step — easy to share and easy to check, so the quality of the work speaks without a new customer decoding it first.",
  ...
  "staten-island": {
    ...
    intro: "You keep the personal referral at the center, and the public proof and contact path get easier for a new customer to use when the referral lands.",
