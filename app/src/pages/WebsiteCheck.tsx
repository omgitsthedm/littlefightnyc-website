...
export default function WebsiteCheck() {
  ...
  // phone). The button answers within the same frame — "Opening the check…",
  // spinner, aria-busy — so the wait is never silent, and
        ...
        >
          ...
          <div className="lf-website-check__automated-controls">
            ...
            <p className="lf-website-check__status" role="status" aria-live="polite">
              {checking !== null ? `Opening the check for ${checking}. Review your request there.` : ""}
            </p>
          </div>
