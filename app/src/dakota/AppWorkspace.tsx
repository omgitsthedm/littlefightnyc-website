  ...
  return (
    <div className="dashboard-shell">
      ...
      <main className="dashboard-main" id="dakota-main">
        ...
        {view === "money" ? <MoneyView state={operatorState} queueRecords={currentRecords} now={now} revenueBridgeState={revenueBridgeState} offerCatalogState={offerCatalogState} archiveState={archiveState} operationsState={operationsState} onOpen={openRecord} onArchive={archiveRecord} onRestore={restoreRecord} /> : null}
