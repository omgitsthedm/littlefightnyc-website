...
const beacons = [
  { anchor: [shops[0].x, 3.9, shops[0].z], biz: 0, down: 1.5, dir: [-0.25, 0.42, -1], dist: 8, kicker: 'Small business sample', title: 'A clearer front door.', body: 'This simulated storefront shows how a website, booking, payments, and menus could connect. The counter is display data, not real orders.' },
  ...
  { anchor: [buildings[0].x, 7.6, buildings[0].z], biz: 6, down: 2.4, dir: [-0.75, 0.35, 0.9], dist: 9.5, kicker: 'Growing teams', title: 'One path for a request.', body: 'This sample shows how intake, scheduling, and invoicing can connect. The activity curve is illustrative, not a record of real leads.' },
  ...
  { anchor: [STREET_X[1] + 1.4, 0.6, AVENUE_Z[0]], biz: 9, down: 0.1, dir: [0.15, 0.85, 0.7], dist: 8.5, kicker: 'The grid', title: 'A connected customer path.', body: 'These pulses are illustrative orders, calls, and bookings. They show how a connected path can look, not activity from a real business.' },
