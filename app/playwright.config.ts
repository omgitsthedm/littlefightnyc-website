...
export default defineConfig({
  testDir: "./tests",
  testMatch: ["meta-measurement.spec.ts", "quality-smoke.spec.ts", "vera-product.spec.ts", "visual-proof.spec.ts", "no-site-intake.spec.ts", "public-route-bootstrap.spec.ts", "shared-acquisition-render.spec.ts", "owner-calculator-handoff.spec.ts"],
  timeout: 45_000,
  expect: {
    timeout: 8_000,
  },
