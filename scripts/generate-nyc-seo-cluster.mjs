...
const hubBody = `<section class="page-hero overhaul-page-hero"><div class="container"><p class="overhaul-kicker">New York City</p><h1 class="overhaul-title">Websites and IT support for local businesses that cannot waste money.</h1><p class="overhaul-deck">Little Fight NYC helps pharmacies, salons, restaurants, shops, studios, clinics, and service businesses get a clearer website, steadier technology, stronger Google visibility, and fewer monthly software bills.</p><div class="overhaul-actions"><a class="btn-fit" href="/fit-check/">Start Here</a><a class="btn-ghost" href="tel:+16463600318">Call if something is broken</a></div><div class="page-updated content-meta" itemscope itemtype="https://schema.org/Person">By <span class="author" itemprop="name">David Marsh</span> · Updated <time datetime="${today}">May 5, 2026</time></div></div></section>
<section class="overhaul-section tight"><div class="container"><div class="pain-strip"><div><p class="overhaul-kicker">Direct answer</p><h2 class="overhaul-title sm">If customers cannot find you, trust you, pay you, or reach you, the digital side is costing you.</h2><p class="overhaul-deck">A business owner should not need five vendors to fix one customer path. The website, Google profile, Wi-Fi, payment tools, booking flow, forms, and follow-up all affect the same thing: whether a real customer can choose you and whether your team can actually handle the work.</p></div><ul class="mess-list"><li>Need a better website? Start with the customer action.</li><li>Need IT support? Start with what is broken or slowing the day.</li><li>Need more local customers? Start with Google, Maps, reviews, and service pages.</li><li>Need lower costs? Start with the tools you pay for but barely use.</li></ul></div></div></section>
<section class="overhaul-section"><div class="container"><p class="overhaul-kicker">Choose the door</p><h2 class="overhaul-title sm">Same local business, connected problems.</h2><div class="overhaul-grid"><article class="system-card"><h3>Small business websites</h3><p>Clear service pages, mobile-first design, trust signals, booking paths, forms, e-commerce, and local search structure.</p><p><a href="/websites/">Open websites &rarr;</a></p></article><article class="system-card"><h3>IT support</h3><p>On-site and practical help for Wi-Fi, printers, POS, computers, device setup, email issues, and systems that stop the workday.</p><p><a href="/it-support/">Open IT support &rarr;</a></p></article><article class="system-card"><h3>Google visibility</h3><p>Google Business Profile cleanup, Maps visibility, reviews, FAQs, service pages, schema, and answer-friendly content.</p><p><a href="/local-search/">Open local search &rarr;</a></p></article><article class="system-card"><h3>Software savings</h3><p>Tool-stack review, subscription cleanup, simple dashboards, lead tracking, and workflows that replace monthly bloat when it makes sense.</p><p><a href="/business-systems/">Open savings &rarr;</a></p></article></div></div></section>
<section class="overhaul-section method-band"><div class="container"><p class="overhaul-kicker">All five boroughs</p><h2 class="overhaul-title sm">NYC businesses do not all need the same setup.</h2><p class="overhaul-deck">A Midtown practice, a Queens pharmacy, a Brooklyn studio, a Bronx service business, and a Staten Island shop face different customer habits, rent pressure, staffing realities, and technology messes. The answer should fit the business, not a template.</p><div class="overhaul-grid three"><article class="system-card"><h3><a href="/areas/manhattan">Manhattan</a></h3><p>High-rent, fast-decision businesses that need polished trust and fewer operational leaks.</p></article><article class="system-card"><h3><a href="/areas/brooklyn">Brooklyn</a></h3><p>Local brands, hospitality, retail, studios, and services that need search, booking, and follow-up to line up.</p></article><article class="system-card"><h3><a href="/areas/queens">Queens</a></h3><p>Community businesses, clinics, restaurants, pharmacies, and shops that need clear sites and reliable day-to-day tech.</p></article><article class="system-card"><h3><a href="/areas/bronx">Bronx</a></h3><p>Neighborhood-serving businesses where phone calls, Maps visibility, payments, and follow-up have to work.</p></article><article class="system-card"><h3><a href="/areas/staten-island">Staten Island</a></h3><p>Local service, retail, wellness, and professional businesses that need practical support without agency fog.</p></article><article class="system-card"><h3><a href="/fit-check/">Not sure?</a></h3><p>Tell us what feels expensive, broken, slow, or disconnected. We will sort the path.</p></article></div></div></section>
${faqMarkup(hubFaqs)}
<section class="overhaul-section tight"><div class="container"><div class="fit-check-band"><p class="overhaul-kicker">Next move</p><h2 class="overhaul-title sm">Bring us the messy setup.</h2><p class="overhaul-deck">Tell us what is draining money, losing customers, breaking the day, or making the business harder than it should be. We will help figure out whether the next move is a quick fix, website cleanup, IT support, local search work, software cleanup, or a right-sized system.</p><div class="overhaul-actions"><a class="btn-fit" href="/fit-check/">Start Here</a><a class="btn-ghost" href="/pricing/">See starting points</a></div></div></div></section>`;

const itFaqs = [
  {
    q: "What counts as small business IT support?",
    a: "For Little Fight NYC, IT support means practical help with the tools that keep the day moving: Wi-Fi, printers, computers, devices, POS, email, domains, forms, accounts, and the systems staff use to serve customers."
  },
  {
    q: "Do you offer on-site IT support in NYC?",
    a: "Yes. Little Fight NYC provides on-site support when a physical business location, device, network, printer, POS setup, or staff workflow needs hands-on help."
  },
  {
  ...
  },
  {
    ...
    a: "No. We fix immediate issues, then help prevent repeat problems with cleaner device setup, better tools, simpler workflows, and ongoing support when useful."
  }
];
...
const itBody = `<section class="page-hero overhaul-page-hero"><div class="container"><p class="overhaul-kicker">IT support</p><h1 class="overhaul-title">Tech help for NYC businesses that need the day to keep moving.</h1><p class="overhaul-deck">Wi-Fi drops. Printers refuse to print. POS freezes. Email goes sideways. Staff cannot access the thing they need. Little Fight NYC helps small businesses fix the problem, steady the setup, and avoid paying for more complexity than they need.</p><div class="overhaul-actions"><a class="btn-fit" href="tel:+16463600318">Call if it is broken</a><a class="btn-ghost" href="/fit-check/">Start a Fit Check</a></div><div class="page-updated content-meta" itemscope itemtype="https://schema.org/Person">By <span class="author" itemprop="name">David Marsh</span> · Updated <time datetime="${today}">May 5, 2026</time></div></div></section>
<section class="overhaul-section tight"><div class="container"><div class="pain-strip"><div><p class="overhaul-kicker">Plain English</p><h2 class="overhaul-title sm">IT support is not the goal. A business day that works is the goal.</h2><p class="overhaul-deck">Most owners do not wake up wanting "managed services." They want the register to work, the team to get online, the printer to stop wasting time, the email to send, the booking tool to behave, and the customer not to notice anything was wrong.</p></div><ul class="mess-list"><li>Something is broken right now.</li><li>The same tech problem keeps coming back.</li><li>Staff waste time on workarounds.</li><li>One person knows how everything is connected.</li><li>The monthly support bill is bigger than the actual help.</li></ul></div></div></section>
<section class="overhaul-section"><div class="container"><p class="overhaul-kicker">What we fix</p><h2 class="overhaul-title sm">Support for the things that block customers, staff, or money.</h2><div class="overhaul-grid"><article class="system-card"><h3>Wi-Fi and networks</h3><p>Coverage problems, unstable office or storefront networks, guest Wi-Fi, router cleanup, and equipment that needs to stop guessing.</p></article><article class="system-card"><h3>POS and payments</h3><p>Square, Toast-adjacent setups, iPad registers, receipt printers, card readers, network reliability, and payment paths that need to hold up.</p></article><article class="system-card"><h3>Devices and accounts</h3><p>Mac, PC, iPad, iPhone, Google Workspace, Microsoft 365, shared access, onboarding, offboarding, and ownership cleanup.</p></article><article class="system-card"><h3>Web, email, and forms</h3><p>Domains, DNS, email routing, website forms, booking embeds, notifications, and the quiet setup pieces that lose leads when they fail.</p></article></div></div></section>
<section class="overhaul-section method-band"><div class="container"><p class="overhaul-kicker">How we route it</p><h2 class="overhaul-title sm">Urgent first. Cleanup second. No drama if a small fix will do.</h2><div class="method-grid"><article class="method-step"><strong>01</strong><h3>Confirm impact</h3><p>Is it affecting customers, payments, booking, email, access, or staff right now?</p></article><article class="method-step"><strong>02</strong><h3>Stabilize</h3><p>Fix or work around the immediate issue so the business can keep moving.</p></article><article class="method-step"><strong>03</strong><h3>Trace the cause</h3><p>Find whether this is one broken thing or part of a larger tool/workflow problem.</p></article><article class="method-step"><strong>04</strong><h3>Prevent repeat pain</h3><p>Simplify, document, connect, or replace the piece that keeps wasting time.</p></article></div></div></section>
<section class="overhaul-section"><div class="container"><p class="overhaul-kicker">Where we help</p><h2 class="overhaul-title sm">NYC IT support by borough.</h2><div class="overhaul-grid three"><article class="system-card"><h3><a href="/areas/manhattan">Manhattan IT support</a></h3><p>Offices, shops, galleries, restaurants, salons, practices, and teams with high cost per hour of downtime.</p></article><article class="system-card"><h3><a href="/areas/brooklyn">Brooklyn IT support</a></h3><p>Retail, hospitality, studios, and service teams that need payments, Wi-Fi, booking, and staff tools to behave.</p></article><article class="system-card"><h3><a href="/areas/queens">Queens IT support</a></h3><p>Community businesses, clinics, restaurants, and shops that need practical help without a corporate IT department.</p></article><article class="system-card"><h3><a href="/areas/bronx">Bronx IT support</a></h3><p>Neighborhood businesses where calls, Maps, payments, and daily tools have to work without expensive overhead.</p></article><article class="system-card"><h3><a href="/areas/staten-island">Staten Island IT support</a></h3><p>Local service, wellness, retail, and professional businesses that need dependable setup and clear support.</p></article><article class="system-card"><h3><a href="/services/on-site-it-support-nyc/">On-site support details</a></h3><p>See the original service page for on-site troubleshooting, device, printer, and network support.</p></article></div></div></section>
${faqMarkup(itFaqs)}
<section class="overhaul-section tight"><div class="container"><div class="fit-check-band"><p class="overhaul-kicker">Next move</p><h2 class="overhaul-title sm">If it is broken, call. If it is messy, start here.</h2><p class="overhaul-deck">For active issues, call Little Fight. For recurring tech problems, software costs, weak websites, or tools that do not line up, start with a Fit Check and we will separate the quick fix from the bigger cleanup.</p><div class="overhaul-actions"><a class="btn-fit" href="tel:+16463600318">Call Little Fight</a><a class="btn-ghost" href="/fit-check/">Start Here</a></div></div></div></section>`;
...
const boroughs = [
  {
    ...
    first: "Check the website, Google profile, lead path, and daily tools before buying another platform."
  },
  {
    slug: "brooklyn",
    name: "Brooklyn",
    ...
    intro: "Brooklyn businesses often run on reputation, repeat customers, neighborhood search, and a lot of owner improvisation. That works until the website is unclear, the booking flow leaks, or the tech stack turns into another rent bill.",
...
function boroughFaqs(borough) {
  return [
    {
      q: `Does Little Fight NYC help ${borough.name} businesses with websites?`,
      a: `Yes. Little Fight NYC helps ${borough.name} businesses build and clean up websites that explain the offer, earn trust, support local search, and turn visits into calls, bookings, purchases, or inquiries.`
    },
    {
      q: `Does Little Fight provide IT support in ${borough.name}?`,
      a: `Yes. Little Fight supports practical IT needs for ${borough.name} businesses, including Wi-Fi, devices, printers, POS, email, domains, forms, and recurring tech problems that slow the day down.`
    },
    {
      q: `Can you help if we are paying too much for software?`,
      a: "Yes. We review what you use now, what is worth keeping, what should be connected, what may need replacing, and whether a smaller right-sized setup could reduce monthly waste."
    },
    {
...
<section class="overhaul-section tight"><div class="container"><div class="pain-strip"><div><p class="overhaul-kicker">Local fit</p><h2 class="overhaul-title sm">For ${borough.businesses}.</h2><p class="overhaul-deck">${borough.first}</p></div><ul class="mess-list">${borough.pain.map((item) => `<li>${item}</li>`).join("")}<li>Keep what works. Connect what matters. Replace what drains cash. Build what fits.</li></ul></div></div></section>
<section class="overhaul-section"><div class="container"><p class="overhaul-kicker">What we help with</p><h2 class="overhaul-title sm">Websites, IT support, search, and savings should work together.</h2><div class="overhaul-grid"><article class="system-card"><h3>${borough.name} website help</h3><p>Clear pages, service structure, mobile experience, photos, proof, forms, booking, e-commerce, and local search signals.</p><p><a href="/websites/">Website help &rarr;</a></p></article><article class="system-card"><h3>${borough.name} IT support</h3><p>Wi-Fi, printers, devices, POS, email, domains, forms, and the practical support a small team needs when technology blocks the day.</p><p><a href="/it-support/">IT support &rarr;</a></p></article><article class="system-card"><h3>Google and Maps visibility</h3><p>Google Business Profile cleanup, reviews, service pages, FAQs, schema, and local content that matches how customers search.</p><p><a href="/local-search/">Get found &rarr;</a></p></article><article class="system-card"><h3>Software cost cleanup</h3><p>Tool review, subscription cleanup, lead tracking, booking/payment workflow, and smaller systems when platforms cost more than they help.</p><p><a href="/business-systems/">Save money &rarr;</a></p></article></div></div></section>
<section class="overhaul-section method-band"><div class="container"><p class="overhaul-kicker">AEO answer</p><h2 class="overhaul-title sm">Who should a ${borough.name} business call for website or IT help?</h2><p class="overhaul-deck">A ${borough.name} business should call Little Fight NYC when the problem touches the website customers see, the tools staff use, the Google listing customers find, or the workflow that handles calls, forms, bookings, payments, and follow-up. The first step is not always a rebuild. Sometimes it is a quick fix, a clearer page, a better contact path, or removing software that stopped helping.</p></div></section>
${faqMarkup(faqs)}
<section class="overhaul-section tight"><div class="container"><div class="fit-check-band"><p class="overhaul-kicker">Next move</p><h2 class="overhaul-title sm">Tell us what is broken, expensive, slow, or hard to explain.</h2><p class="overhaul-deck">We will help sort whether the right next step is urgent support, website cleanup, local search work, software savings, or a right-sized business system.</p><div class="overhaul-actions"><a class="btn-fit" href="/fit-check/">Start Here</a><a class="btn-ghost" href="/nyc-websites-it-support/">Open the NYC hub</a></div></div></div></section>`;
...
for (const file of htmlFiles) {
  ...
  if (file.endsWith(path.join("websites", "index.html"))) {
    ...
    if (!html.includes("For exact NYC website and IT support coverage")) {
      html = html.replace(
        ...
        '<h2 class="overhaul-title sm">Different local businesses need different proof.</h2><p class="overhaul-deck">For exact NYC website and IT support coverage across Manhattan, Brooklyn, Queens, the Bronx, and Staten Island, start with the <a href="/nyc-websites-it-support/">NYC websites and IT support hub</a>.</p>'
      );
    }
  }
  ...
  if (file.endsWith(path.join("services", "index.html")) && !html.includes("Need the citywide version?")) {
    html = html.replace(
      ...
      '<section class="overhaul-section tight"><div class="container"><div class="fit-check-band"><p class="overhaul-kicker">NYC websites and IT support</p><h2 class="overhaul-title sm">Need the citywide version?</h2><p class="overhaul-deck">Open the NYC hub for website design, IT support, Google visibility, and software cleanup across Manhattan, Brooklyn, Queens, the Bronx, and Staten Island.</p><div class="overhaul-actions"><a class="btn-fit" href="/nyc-websites-it-support/">Open the NYC hub</a><a class="btn-ghost" href="/it-support/">Open IT support</a></div></div></div></section><section class="overhaul-section method-band">'
    );
  }
