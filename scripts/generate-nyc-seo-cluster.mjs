...
const hubFaqs = [
  ...
  },
  {
    ...
    a: "Yes. That is exactly what the Tech Audit is for. We look at what is broken, expensive, confusing, or disconnected, then point you toward the smallest useful next step."
  },
  {
...
const itBody = `<section class="page-hero overhaul-page-hero"><div class="container"><p class="overhaul-kicker">IT support</p><h1 class="overhaul-title">IT support that keeps the day moving.</h1><p class="overhaul-deck">Wi-Fi drops. POS freezes. Email breaks. We fix the thing blocking customers or staff, then help keep it from coming back.</p><div class="overhaul-actions"><a class="btn-fit" href="tel:+16463600318">Call if it is broken</a><a class="btn-ghost" href="/tech-audit/">Start a Tech Audit</a></div><div class="page-updated content-meta" itemscope itemtype="https://schema.org/Person">By <span class="author" itemprop="name">David Marsh</span> · Updated <time datetime="${today}">May 5, 2026</time></div></div></section>
...
${faqMarkup(itFaqs)}
<section class="overhaul-section tight"><div class="container"><div class="tech-audit-band"><p class="overhaul-kicker">Next move</p><h2 class="overhaul-title sm">If it is broken, call. If it is messy, start here.</h2><p class="overhaul-deck">If it is broken now, call. If it keeps coming back, start with a Tech Audit.</p><div class="overhaul-actions"><a class="btn-fit" href="tel:+16463600318">Call Little Fight</a><a class="btn-ghost" href="/tech-audit/">Start Here</a></div></div></div></section>`;
...
function boroughFaqs(borough) {
  ...
  return [
    ...
    },
    {
      ...
      a: "Start with a Tech Audit if the issue is messy or unclear. Call if something is actively affecting customers, payments, bookings, email, website access, or staff access right now."
    }
  ];
}
...
function boroughPage(borough) {
  ...
  const body = `<section class="page-hero overhaul-page-hero"><div class="container"><p class="overhaul-kicker">${borough.name}, NYC</p><h1 class="overhaul-title">${borough.hero}</h1><p class="overhaul-deck">${borough.intro}</p><div class="overhaul-actions"><a class="btn-fit" href="/tech-audit/">Start Here</a><a class="btn-ghost" href="tel:+16463600318">Call if it is broken</a></div><div class="page-updated content-meta" itemscope itemtype="https://schema.org/Person">By <span class="author" itemprop="name">David Marsh</span> · Updated <time datetime="${today}">May 5, 2026</time></div></div></section>
...
${faqMarkup(faqs)}
<section class="overhaul-section tight"><div class="container"><div class="tech-audit-band"><p class="overhaul-kicker">Next move</p><h2 class="overhaul-title sm">Tell us what is broken, expensive, slow, or hard to explain.</h2><p class="overhaul-deck">We will help sort whether this needs urgent support, website cleanup, Google help, software savings, or a simple system.</p><div class="overhaul-actions"><a class="btn-fit" href="/tech-audit/">Start Here</a><a class="btn-ghost" href="/nyc-websites-it-support/">Open the NYC hub</a></div></div></div></section>`;
...
for (const file of htmlFiles) {
  ...
  if (file === path.join(root, "index.html")) {
    html = html
      ...
      .replaceAll(' aria-label="Lead capture and Tech Audit help"', "")
